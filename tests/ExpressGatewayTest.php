...
class ExpressGatewayTest extends GatewayTestCase
{
    ...
    public function testAuthorizeSuccess()
    {
        ...
        $this->assertInstanceOf('\Nilead\PaymentGateway\NganLuong\Message\ExpressAuthorizeResponse', $response);
    ...
    public function testFetchCheckout()
    {
        ...
        $this->assertInstanceOf('\Nilead\PaymentGateway\NganLuong\Message\ExpressFetchCheckoutRequest', $request);
