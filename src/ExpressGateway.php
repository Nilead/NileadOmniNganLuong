...
class ExpressGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Nilead\OmniNganLuong\src\Message\ExpressAuthorizeRequest', $parameters);
    }

    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('\Nilead\OmniNganLuong\src\Message\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Nilead\OmniNganLuong\src\Message\ExpressCompletePurchaseRequest', $parameters);
    }

    public function fetchCheckout(array $parameters = array())
    {
        return $this->createRequest('\Nilead\OmniNganLuong\src\Message\ExpressFetchCheckoutRequest', $parameters);
    }
}
